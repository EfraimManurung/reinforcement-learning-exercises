...
All keys other than "type" in the logger_config dict will be passed into the Logger class's constructor.
...
these logged lines will mix with the ones produce by Tune's default ProgressReporter.
...
class MyPrintLogger(Logger):
    ...
    def on_result(self, result: dict):
        # Define, what should happen on receiveng a `result` (dict).
...
if __name__ == "__main__":
    config = (
        ...
        # SEttin up a custom logger config.
        # ---------------------------------
        ...
        .debugging(
            logger_config={
                # Provide tha class directly or via fully qualified class path
                "type": MyPrintLogger,
                # `config` keys:
                "prefix": "ABC",
                # Optional: Custom logdir (do not define this here
